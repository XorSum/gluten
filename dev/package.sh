...
function process_setup_almalinux_9 {
  ...
  cp /usr/local/lib/{libboost_context.so.1.72.0,libboost_filesystem.so.1.72.0,libboost_program_options.so.1.72.0,libboost_regex.so.1.72.0,libboost_system.so.1.72.0,libboost_thread.so.1.72.0,libhdfs3.so.1,libprotobuf.so.32}  $THIRDPARTY_LIB/
  cp /usr/local/lib64/{libgflags.so.2.2,libglog.so.1}  $THIRDPARTY_LIB/
}
